...
public class MultipleGroupActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSectionMultiData();
        mAdapter = new MultipleGroupAdapter(R.layout.def_section_head, mData);
    ...
    public void notifyDataSetChangedss() {

        mData.add(new MultipleGroupItem(MultipleGroupItem.HEART_CARD_ITEM, true, "心动卡牌 ", true));//头部
